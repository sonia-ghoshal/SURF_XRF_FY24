...
//
// We corrected the measure state monitoring routine to wait for  
// either an 80% completion of scan OR < 10s LiveTime remaining
// if either condition is met, both the LiveTime and RealTime are
// pulled, and divided to give dead time % (Real/Live)* 100
// this is then multipled by live remaining (LiveTimeReqested - 10s)
// to give remaining real time to wait.  We then wait an additional
// 1s.
//
// based off Bruker Caldera test script.  edited by DW last on 20190813
//
//  DISABLED X,Y,Z stages from moving 20240626
//
//--------------------------------------------------------------
...
BEGIN
   ...
   Current_FE     := 100;    // in mA
   LiveTime_FE    := 60000;   // in ms
   ...
   LiveTime_F5    := 600000;   // in ms
   //
   /////////
   // Sudirectory where and prefix name of files to be saved
   //
   DirectoryName := 'C:\M4 User\Xrf\Data\Ghoshal\20240723_K157_2nm_Rotation\45_deg\';
   FileName:= DirectoryName + '20240729_K157_2nm_Rotation_45_deg_';
   //
   ////////
   ...
   //
   TargetDirectoryName := 'C:\M4 User\Xrf\Data\Ghoshal\20240723_K157_2nm_Rotation\45_deg\';
   TargetFileName := TargetDirectoryName + 'target_locations_single.txt';
   ZOffsetFileName := TargetDirectoryName + 'Z_offset_10.txt'
   ...
   ZFocus := 81.18
   //
   //X := 101.17; //Target positions only used for testing purposes
   //Y := 78.92;  //Target positions only used for testing purposes
   //
   //
   ////////////////////////
   ////////////////////////
            ...
            If F1 = True Then
               ...
               If Det1 = True Then
                  ...
                  REPEAT
                     ...
                     Variable := (RealTime * 1.0) / (LifeTime * 1.0);
                     //writeln('Dead Time ratio: ' + FloatToStr(Variable));
                  UNTIL (LifeTime > (LiveTime_F1 - 10000)) OR (MeasureState > 80.0);
                  writeln('1000ms counter det1: ' + IntToStr(Timer));
                  writeln('Measure State: ' + FloatToStr(MeasureState));
                  writeln('RealTime: ' + IntToStr(RealTime));
                  writeln('LifeTime: ' + IntToStr(LifeTime));
                  writeln('Dead Time ratio: ' + FloatToStr(Variable));
                  TimeLeft := round((LiveTime_F1 - LifeTime) * Variable);
                  writeln('TimeLeft: ' + IntToStr(TimeLeft));
                  sleep(TimeLeft);
                  sleep(1000);
                  SPUReadSpectrum(ActiveDetector);
            ...
            If F2 = True Then
               ...
               If Det1 = True Then
                  ...
                  REPEAT
                     ...
                     Variable := (RealTime * 1.0) / (LifeTime * 1.0);
                     //writeln('Dead Time ratio: ' + FloatToStr(Variable));
                  UNTIL (LifeTime > (LiveTime_F2 - 10000)) OR (MeasureState > 80.0);
                  writeln('1000ms counter det1: ' + IntToStr(Timer));
                  writeln('Measure State: ' + FloatToStr(MeasureState));
                  writeln('RealTime: ' + IntToStr(RealTime));
                  writeln('LifeTime: ' + IntToStr(LifeTime));
                  writeln('Dead Time ratio: ' + FloatToStr(Variable));
                  TimeLeft := round((LiveTime_F2 - LifeTime) * Variable);
                  writeln('TimeLeft: ' + IntToStr(TimeLeft));
                  sleep(TimeLeft);
                  sleep(1000);
                  SPUReadSpectrum(ActiveDetector);
            ...
            If F3 = True Then
               ...
               If Det1 = True Then
                  ...
                  REPEAT
                     ...
                     Variable := (RealTime * 1.0) / (LifeTime * 1.0);
                     //writeln('Dead Time ratio: ' + FloatToStr(Variable));
                  UNTIL (LifeTime > (LiveTime_F3 - 10000)) OR (MeasureState > 80.0);
                  writeln('1000ms counter det1: ' + IntToStr(Timer));
                  writeln('Measure State: ' + FloatToStr(MeasureState));
                  writeln('RealTime: ' + IntToStr(RealTime));
                  writeln('LifeTime: ' + IntToStr(LifeTime));
                  writeln('Dead Time ratio: ' + FloatToStr(Variable));
                  TimeLeft := round((LiveTime_F3 - LifeTime) * Variable);
                  writeln('TimeLeft: ' + IntToStr(TimeLeft));
                  sleep(TimeLeft);
                  sleep(1000);
                  SPUReadSpectrum(ActiveDetector);
            ...
            If F4 = True Then
               ...
               If Det1 = True Then
                  ...
                  REPEAT
                     ...
                     Variable := (RealTime * 1.0) / (LifeTime * 1.0);
                     //writeln('Dead Time ratio: ' + FloatToStr(Variable));
                  UNTIL (LifeTime > (LiveTime_F4 - 10000)) OR (MeasureState > 80.0);
                  writeln('1000ms counter det1: ' + IntToStr(Timer));
                  writeln('Measure State: ' + FloatToStr(MeasureState));
                  writeln('RealTime: ' + IntToStr(RealTime));
                  writeln('LifeTime: ' + IntToStr(LifeTime));
                  writeln('Dead Time ratio: ' + FloatToStr(Variable));
                  TimeLeft := round((LiveTime_F4 - LifeTime) * Variable);
                  writeln('TimeLeft: ' + IntToStr(TimeLeft));
                  sleep(TimeLeft);
                  sleep(1000);
                  SPUReadSpectrum(ActiveDetector);
            ...
            If F5 = True Then
               ...
               If Det1 = True Then
                  ...
                  REPEAT
                     ...
                     Variable := (RealTime * 1.0) / (LifeTime * 1.0);
                     //writeln('Dead Time ratio: ' + FloatToStr(Variable));
                  UNTIL (LifeTime > (LiveTime_F5 - 10000)) OR (MeasureState > 80.0);
                  writeln('1000ms counter det1: ' + IntToStr(Timer));
                  writeln('Measure State: ' + FloatToStr(MeasureState));
                  writeln('RealTime: ' + IntToStr(RealTime));
                  writeln('LifeTime: ' + IntToStr(LifeTime));
                  writeln('Dead Time ratio: ' + FloatToStr(Variable));
                  TimeLeft := round((LiveTime_F5 - LifeTime) * Variable);
                  writeln('TimeLeft: ' + IntToStr(TimeLeft));
                  sleep(TimeLeft);
                  sleep(1000);
                  SPUReadSpectrum(ActiveDetector);
