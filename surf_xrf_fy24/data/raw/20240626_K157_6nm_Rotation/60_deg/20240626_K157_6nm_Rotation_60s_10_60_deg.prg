...
BEGIN
   ...
   //
   DirectoryName := 'C:\M4 User\Xrf\Data\Ghoshal\20240626_K157_6nm_Rotation\60_deg\';
   FileName:= DirectoryName + '20240626_K157_6nm_Rotation_60_deg_';
   //
   ////////
   ...
   //
   TargetDirectoryName := 'C:\M4 User\Xrf\Data\Ghoshal\20240626_K157_6nm_Rotation\60_deg\';
   ...
   ZFocus := 81.21
   //
   //X := 100.41; //Target positions only used for testing purposes
   //Y := 78.55;  //Target positions only used for testing purposes
   //
   //
   ////////////////////////
   ////////////////////////
